<script lang="ts">
	...
	console.log("Conv object:", JSON.stringify(conv, null, 2));
</script>
...
<a
	...
	class="group flex flex-col gap-0.5 rounded-lg pl-2.5 pr-2 text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 {conv.id ===
	page.params.id
